...
<qgis version="2.8.2-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="tramway" label="Трамвай"/>
      <category render="true" symbol="1" value="trolleybus" label="Троллейбус"/>
      <category render="true" symbol="2" value="bus" label="Автобус"/>
      <category render="true" symbol="3" value="minibus" label="Маршрутка"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="227,33,36,255"/>
